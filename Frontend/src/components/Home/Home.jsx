            ...
            <body>
                <div id="home" className='w-full hero-container min-h-[700px]'>
                    ...
                    <div className='top-[4rem] left-[4rem] absolute inset-0 flex-col text-white inline-block'>
                        ...
                        <NavLink to="/register" className="bg-[#646c3c] h-[8vh] inline-flex p-[1.8rem]  font-serif items-center rounded-[2rem] text-[1.2rem] hover:bg-[#80904c] shadow-lg " activeClass="">Join the Movement</NavLink>
                    </div>
