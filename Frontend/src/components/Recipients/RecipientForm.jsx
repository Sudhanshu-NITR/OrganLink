...
const RecipientForm = ({isFormOpen, setIsFormOpen, donor_id}) => {
  ...
  return (
    <div className={`min-w-[40rem] rounded-b-lg border border-black/10 font-serif bg-gray-100`}>
      <form onSubmit={handleSubmit(addRecipient)} className="space-y-5 p-8 rounded-b-lg font-medium bg-gray-50">
